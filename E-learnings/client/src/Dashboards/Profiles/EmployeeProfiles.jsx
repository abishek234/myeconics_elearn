...
const EmployeeProfile = ({ userId }) => {
    ...
    useEffect(() => {
        const fetchEmployeeProfile = async () => {
            try {
                const response = await axios.get(`http://localhost:9000/api/employees/employee/${userId}`);
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            ...
            const response = await axios.put(`http://localhost:9000/api/employees/employee/${userId}`, updatedEmployee);
            setEmployee(response.data);
                        ...
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={12}>
                                <TextField 
                                    ...
                                    onChange={(e) => setEmployee({ ...employee, classid: e.target.value })}
                                />
                            </Grid>
                            <Grid item xs={12}>
                                <TextField 
                            ...
                            <Grid item xs={12}>
                                <TextField
                                    ...
                                    value={employee.dateofbirth.split('T')[0]} // Format date for input
